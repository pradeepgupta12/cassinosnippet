    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-[#1A1A3D] to-[#2E2E5A] py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-white/90 mb-6 max-w-2xl mx-auto">
            Discover the best online casinos for Dice games in India. Play with trusted operators and enjoy exclusive bonuses.
          </p>
      ...
      <div className="py-6 sm:py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {pokerCasinos.length === 0 ? (
            <div className="text-center py-12">
              <h3 className="text-xl font-semibold text-gray-700 mb-2">No Casinos Found</h3>
              <p className="text-gray-500">Check back later for more Dice casinos!</p>
            </div>
          ) : (
            <div className="space-y-4 sm:space-y-6">
              {pokerCasinos.map((casino) => (
