...
import { bet22Data } from '../Data/bet22Data';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <section className="bg-gradient-to-r from-purple-600 to-blue-500 rounded-xl p-6 mb-6 text-white">
        <div className="flex flex-col sm:flex-row justify-between items-start">
          <div className="flex-1">
            <h1 className="text-2xl sm:text-3xl font-bold mb-3">{bet22Data.overview.tagline}</h1>
            <p className="text-base mb-4 max-w-4xl">{bet22Data.overview.description}</p>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 bg-white rounded-full flex items-center justify-center">
                <User className="w-5 h-5 text-purple-600" />
              </div>
              <div>
                <p className="font-semibold text-sm">- {bet22Data.overview.author}</p>
                <p className="text-xs opacity-90">{bet22Data.overview.author_title}</p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-white rounded-xl p-6 mb-6">
        <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-gray-800">{bet22Data.welcome_bonus.title}</h2>
              <p className="text-xl font-bold text-blue-800">{bet22Data.welcome_bonus.offer}</p>
            </div>
          </div>
          <div className="flex flex-col items-start sm:items-end gap-3 w-full sm:w-auto">
            ...
            <div className="bg-orange-50 px-3 py-1 rounded-lg">
              <p className="text-xs text-orange-700">{bet22Data.welcome_bonus.recent_visitors}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mb-6">
        ...
        <div className="space-y-3">
          {Object.entries(bet22Data.overall_rating).map(([key, value]) => (
      ...
      {/* Review Section */}
      <section className="bg-white rounded-xl p-6 mb-6">
        <h2 className="text-xl font-bold text-gray-800 mb-4">{bet22Data.review.title}</h2>
        <div className="prose max-w-none">
          {bet22Data.review.content.split('\n\n').map((paragraph, index) => (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div>
            ...
            <div className="space-y-2">
              {bet22Data.pros_cons.pros.map((pro, index) => (
          ...
          <div>
            ...
            <div className="space-y-2">
              {bet22Data.pros_cons.cons.map((con, index) => (
                <div key={index} className="flex items-start gap-2">
      ...
      {/* Details Section */}
      <section className="bg-white rounded-xl p-6 mb-6">
        <h2 className="text-xl font-bold text-gray-800 mb-4">What you should remember about 22BET</h2>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-700 text-sm">{bet22Data.details.casino_name}</span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-700 text-sm">{bet22Data.details.owner}</span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-700 text-sm">{bet22Data.details.year_established}</span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-700 text-sm">{bet22Data.details.number_of_games}</span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-700 text-sm">{bet22Data.details.games_offered}</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-700 text-sm">{bet22Data.details.compatible_devices}</span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-700 text-sm">{bet22Data.details.payout_percentage}</span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-700 text-sm">{bet22Data.details.payout_days}</span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-700 text-sm">{bet22Data.details.languages}</span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <span className="ml-2 text-gray-700 text-sm">{bet22Data.details.software_used}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* History Section */}
      <section className="bg-white rounded-xl p-6 mb-6">
        <h2 className="text-xl font-bold text-gray-800 mb-3">{bet22Data.history.title}</h2>
        <p className="text-gray-700 mb-6 text-sm">{bet22Data.history.description}</p>
        <div className="space-y-4">
          {bet22Data.history.timeline.map((item, index) => (
      ...
      <section className="bg-white rounded-xl p-6 mb-6">
        <h2 className="text-xl font-bold text-gray-800 mb-4">Breakdown of welcome bonus at 22BET</h2>
        <div className="space-y-3">
          {Object.entries(bet22Data.welcome_bonus_details).map(([key, value]) => (
      ...
      {/* Other Bonuses */}
      <section className="mb-6">
        <h2 className="text-xl font-bold text-gray-800 mb-4">Bonuses at 22BET that will surprise you</h2>
        <div className="space-y-4">
          {bet22Data.other_bonuses.map((bonus, index) => (
      ...
      <section className="bg-white rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
          <div>
            ...
            <div className="space-y-2">
              {bet22Data.customer_service.strengths.map((strength, index) => (
                <div key={index} className="flex items-start gap-2">
                  <Check className="w-4 h-4 text-green-600 mt-0.5 flex-shrink-0" />
          ...
          <div>
            ...
            <div className="space-y-2">
              {bet22Data.customer_service.improvements.map((improvement, index) => (
                <div key={index} className="flex items-start gap-2">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mb-3 text-sm">The following will shed light on the available methods of contacting customer support at 22BET:</p>
          <div className="space-y-2">
            {Object.entries(bet22Data.customer_service.response_times).map(([method, status]) => {
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="px-2 py-1 bg-green-100 text-green-800 rounded text-xs">
              {bet22Data.customer_service.faq}
            </span>
          </div>
        </div>
      </section>
