...
const PokerGame = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section (updated for Poker) */}
      <div className="bg-gradient-to-r from-[#1A1A3D] to-[#2E2E5A] py-12 sm:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-white/90 mb-6 max-w-2xl mx-auto">
            Discover the best online casinos for Poker in India. Play with trusted operators and enjoy exclusive bonuses.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {pokerCasinos.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">Check back later for more Poker casinos!</p>
            </div>
          ) : (
